...
public class BangumiRecommendedModle {

    public class BangumiRecommendBodyTypeModle implements BangumiFragment.Visitable{
        public BangumiRecommendedModle.ResultBean data;

        public BangumiRecommendBodyTypeModle(BangumiRecommendedModle.ResultBean data){
            this.data=data;
        }
...
//        public int form;
//        public ArrayList<ChildBean> list;
