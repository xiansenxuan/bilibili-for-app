...
public class BroadcastTableModle {

    //自我包装的数据modle
    public class SeasonHeadTypeModle   implements BroadcastTableActivity.Visitable{
        public SeasonModle data;

        public SeasonHeadTypeModle(SeasonModle data) {
            this.data = data;
        }

        @Override
        public int type(BroadcastTableActivity.TypeFactory typeFactory) {
            return typeFactory.type(this);
        }
    }

    public class SeasonBodyTypeModle   implements BroadcastTableActivity.Visitable{
        public BroadcastTableModle.ResultBean data;

        public SeasonBodyTypeModle(ResultBean data) {
            this.data = data;
        }
