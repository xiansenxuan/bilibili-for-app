...
public class RxSupportFragment extends RxFragment implements IRxFragmentInter {
    // LaunchMode
    ...
    protected RxFragmentationDelegate mRxFragmentationDelegate;
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof RxSupportActivity) {
            ...
            mRxFragmentationDelegate = _mActivity.getRxFragmentationDelegate();
        } else {
            throw new RuntimeException(activity.getClass().getSimpleName() + " must extends RxSupportActivity!");
        }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            mIsRoot = bundle.getBoolean(RxFragmentationDelegate.FRAGMENTATION_ARG_IS_ROOT, false);
            mIsSharedElement = bundle.getBoolean(RxFragmentationDelegate.FRAGMENTATION_ARG_IS_SHARED_ELEMENT, false);
            mContainerId = bundle.getInt(RxFragmentationDelegate.FRAGMENTATION_ARG_CONTAINER);
        }
        ...
        if (savedInstanceState == null) {
            ...
            mFragmentAnimator = savedInstanceState.getParcelable(RxFragmentationDelegate.FRAGMENTATION_STATE_SAVE_ANIMATOR);
            mIsHidden = savedInstanceState.getBoolean(RxFragmentationDelegate.FRAGMENTATION_STATE_SAVE_IS_HIDDEN);
            if (mContainerId == 0) { // After strong kill, mContianerId may not be correct restored.
                mIsRoot = savedInstanceState.getBoolean(RxFragmentationDelegate.FRAGMENTATION_ARG_IS_ROOT, false);
                mIsSharedElement = savedInstanceState.getBoolean(RxFragmentationDelegate.FRAGMENTATION_ARG_IS_SHARED_ELEMENT, false);
                mContainerId = savedInstanceState.getInt(RxFragmentationDelegate.FRAGMENTATION_ARG_CONTAINER);
            }
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (mIsRoot) {
            outState.putBoolean(RxFragmentationDelegate.FRAGMENTATION_ARG_IS_ROOT, true);
        }
        if (mIsSharedElement) {
            outState.putBoolean(RxFragmentationDelegate.FRAGMENTATION_ARG_IS_SHARED_ELEMENT, true);
        }
        outState.putInt(RxFragmentationDelegate.FRAGMENTATION_ARG_CONTAINER, mContainerId);
        outState.putParcelable(RxFragmentationDelegate.FRAGMENTATION_STATE_SAVE_ANIMATOR, mFragmentAnimator);
        outState.putBoolean(RxFragmentationDelegate.FRAGMENTATION_STATE_SAVE_IS_HIDDEN, isHidden());
    ...
    /**
     * 设定当前Fragmemt动画,优先级比在RxSupportActivity里高
     */
    ...
    /**
     * 按返回键触发,前提是RxSupportActivity的onBackPressed()方法能被调用
     *
    ...
    public void loadRootFragment(int containerId, RxSupportFragment toFragment) {
        mRxFragmentationDelegate.loadRootTransaction(getChildFragmentManager(), containerId, toFragment);
    }
    ...
    public void replaceLoadRootFragment(int containerId, RxSupportFragment toFragment, boolean addToBack) {
        mRxFragmentationDelegate.replaceLoadRootTransaction(getChildFragmentManager(), containerId, toFragment, addToBack);
    }
    ...
    public void loadMultipleRootFragment(int containerId, int showPosition, RxSupportFragment... toFragments) {
        mRxFragmentationDelegate.loadMultipleRootTransaction(getChildFragmentManager(), containerId, showPosition, toFragments);
    }
     ...
     * <p>
     * 建议使用更明确的{@link (RxSupportFragment, RxSupportFragment)}
     *
    ...
    public void showHideFragment(RxSupportFragment showFragment, RxSupportFragment hideFragment) {
        mRxFragmentationDelegate.showHideFragment(getChildFragmentManager(), showFragment, hideFragment);
    }
    ...
    public void start(final RxSupportFragment toFragment, @LaunchMode final int launchMode) {
        mRxFragmentationDelegate.dispatchStartTransaction(getFragmentManager(), this, toFragment, 0, launchMode, RxFragmentationDelegate.TYPE_ADD);
    }

    @Override
    public void startForResult(RxSupportFragment toFragment, int requestCode) {
        mRxFragmentationDelegate.dispatchStartTransaction(getFragmentManager(), this, toFragment, requestCode, STANDARD, RxFragmentationDelegate.TYPE_ADD_RESULT);
    }

    @Override
    public void startWithPop(RxSupportFragment toFragment) {
        mRxFragmentationDelegate.dispatchStartTransaction(getFragmentManager(), this, toFragment, 0, STANDARD, RxFragmentationDelegate.TYPE_ADD_WITH_POP);
    }

    @Override
    public void replaceFragment(RxSupportFragment toFragment, boolean addToBack) {
        mRxFragmentationDelegate.replaceTransaction(this, toFragment, addToBack);
    }
    ...
    public RxSupportFragment getTopFragment() {
        return mRxFragmentationDelegate.getTopFragment(getFragmentManager());
    }
    ...
    public RxSupportFragment getTopChildFragment() {
        return mRxFragmentationDelegate.getTopFragment(getChildFragmentManager());
    }
    ...
    public RxSupportFragment getPreFragment() {
        return mRxFragmentationDelegate.getPreFragment(this);
    }
    ...
    public <T extends RxSupportFragment> T findFragment(Class<T> fragmentClass) {
        return mRxFragmentationDelegate.findStackFragment(fragmentClass, null, getFragmentManager());
    }

    @Override
    public <T extends RxSupportFragment> T findFragment(String fragmentTag) {
        RxFragmentationDelegate.checkNotNull(fragmentTag, "tag == null");
        return mRxFragmentationDelegate.findStackFragment(null, fragmentTag, getFragmentManager());
    }
    ...
    public <T extends RxSupportFragment> T findChildFragment(Class<T> fragmentClass) {
        return mRxFragmentationDelegate.findStackFragment(fragmentClass, null, getChildFragmentManager());
    }

    @Override
    public <T extends RxSupportFragment> T findChildFragment(String fragmentTag) {
        RxFragmentationDelegate.checkNotNull(fragmentTag, "tag == null");
        return mRxFragmentationDelegate.findStackFragment(null, fragmentTag, getChildFragmentManager());
    }
    ...
    @Override
    public void pop() {
        mRxFragmentationDelegate.back(getFragmentManager());
    }
    ...
    public void popChild() {
        mRxFragmentationDelegate.back(getChildFragmentManager());
    }
    ...
    public void popTo(String targetFragmentTag, boolean includeTargetFragment, Runnable afterPopTransactionRunnable) {
        mRxFragmentationDelegate.popTo(targetFragmentTag, includeTargetFragment, afterPopTransactionRunnable, getFragmentManager());
    }
    ...
    public void popToChild(String targetFragmentTag, boolean includeTargetFragment, Runnable afterPopTransactionRunnable) {
        mRxFragmentationDelegate.popTo(targetFragmentTag, includeTargetFragment, afterPopTransactionRunnable, getChildFragmentManager());
    }
    ...
    public void setFragmentResult(int resultCode, Bundle bundle) {
        ...
        if (args == null || !args.containsKey(RxFragmentationDelegate.FRAGMENTATION_ARG_RESULT_RECORD)) {
            return;
        }

        ResultRecord resultRecord = args.getParcelable(RxFragmentationDelegate.FRAGMENTATION_ARG_RESULT_RECORD);
    ...
    public void onDestroy() {
        mRxFragmentationDelegate.handleResultRecord(this);
        super.onDestroy();
