 ...
 */
public class RxFragmentationDelegate {
    ...
    RxFragmentationDelegate(RxSupportActivity activity) {
    ...
    RxSupportFragment getActiveFragment(RxSupportFragment parentFragment, FragmentManager fragmentManager) {
        ...
        for (int i = fragmentList.size() - 1; i >= 0; i--) {
            Fragment fragment = fragmentList.get(i);
            if (fragment instanceof RxSupportFragment) {
                RxSupportFragment RxSupportFragment = (RxSupportFragment) fragment;
                if (RxSupportFragment.isResumed() && !RxSupportFragment.isHidden() && RxSupportFragment.getUserVisibleHint()) {
                    return getActiveFragment(RxSupportFragment, RxSupportFragment.getChildFragmentManager());
                }
            }
        }
        return parentFragment;
