...
public class LoveHeartView extends RelativeLayout {
    ...
    public LoveHeartView(Context context, AttributeSet attrs) {

        this(context, attrs, 0);
    }


    public LoveHeartView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        Drawable one = ContextCompat.getDrawable(getContext(), R.drawable.ic_live_like_01);
        Drawable two = ContextCompat.getDrawable(getContext(), R.drawable.ic_live_like_02);
        Drawable three = ContextCompat.getDrawable(getContext(), R.drawable.ic_live_like_03);
        Drawable four = ContextCompat.getDrawable(getContext(), R.drawable.ic_live_like_04);
        Drawable five = ContextCompat.getDrawable(getContext(), R.drawable.ic_live_like_05);
        drawables[0] = one;
        drawables[1] = two;
        drawables[2] = three;
        drawables[3] = four;
