...
public class MediaController extends FrameLayout {
  ...
  protected View makeControllerView() {
    ...
    return ((LayoutInflater) mContext
        ...
        R.layout.item_media_controller, this);
  }
  ...
  public void hide() {
    ...
    if (mShowing) {
      ...
      try {
        ...
        com.orhanobut.logger.Logger.e("MediaController already removed");
      }
      mShowing = false;
  ...
  private void updatePausePlay() {
    ...
    if (mPlayer.isPlaying()) {
      ...
      mTvPlay.setImageResource(R.drawable.icon_stop);
    } else {
      mPauseButton.setImageResource(R.drawable.bili_player_play_can_play);
      mTvPlay.setImageResource(R.drawable.icon_play);
    }
  }
