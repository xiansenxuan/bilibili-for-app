...
public class CircleProgressDialog extends View {
    ...
    public CircleProgressDialog(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.CircleProgressDialog));
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.CircleProgressDialog_matProg_circleRadius,
                circleRadius);

        fillRadius = a.getBoolean(R.styleable.CircleProgressDialog_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.CircleProgressDialog_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.CircleProgressDialog_matProg_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.CircleProgressDialog_matProg_spinSpeed,
                spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.CircleProgressDialog_matProg_barSpinCycleTime,
                (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.CircleProgressDialog_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.CircleProgressDialog_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.CircleProgressDialog_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.CircleProgressDialog_matProg_progressIndeterminate, false)) {
            spin();
        }
